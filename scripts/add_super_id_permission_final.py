...
and manually generated UUIDs for new records. It handles composite primary keys correctly.
"""
        ...
        with conn.cursor() as cur:
            ...
            try:
                ...
                if existing_role_perm:
                    ...
                    # Assign permission to role - using only the required columns (no id column)
                    # Let the database handle created_at and updated_at if needed
                    cur.execute(
                ...
                if existing_client_role:
                    ...
                    # Assign role to client - using only the required columns (no id column)
                    # Let the database handle created_at and updated_at if needed
                    cur.execute(
