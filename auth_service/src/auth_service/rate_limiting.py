...
DEFAULT_PASSWORD_RESET_RATE_LIMIT = os.environ.get(
...
def setup_rate_limiting(app):
    ...
    if IS_TEST_MODE:
        ...
        logger.info(
            f"Rate limiting is enabled with the following limits: Login={LOGIN_LIMIT}, Registration={REGISTRATION_LIMIT}, PasswordReset={PASSWORD_RESET_LIMIT}, Token={TOKEN_LIMIT}"
        )
