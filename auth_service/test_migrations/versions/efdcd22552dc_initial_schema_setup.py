...
Revision ID: efdcd22552dc
Revises: 
Create Date: 2025-06-03 16:35:48.789043
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_app_clients_client_name'), 'app_clients', ['client_name'], unique=True)
    ...
    op.create_index(op.f('ix_app_client_refresh_tokens_app_client_id'), 'app_client_refresh_tokens', ['app_client_id'], unique=False)
    op.create_index(op.f('ix_app_client_refresh_tokens_token_hash'), 'app_client_refresh_tokens', ['token_hash'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_app_client_refresh_tokens_token_hash'), table_name='app_client_refresh_tokens')
    op.drop_index(op.f('ix_app_client_refresh_tokens_app_client_id'), table_name='app_client_refresh_tokens')
