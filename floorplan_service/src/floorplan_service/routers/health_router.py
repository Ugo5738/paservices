...
from floorplan_service.clients.auth_service_client import auth_service_client
from floorplan_service.clients.super_id_service_client import super_id_service_client
from floorplan_service.config import settings
from floorplan_service.db import get_db
from floorplan_service.schemas.common import (
    ComponentHealth,
    HealthCheckResponse,
    HealthStatus,
)
...
async def detailed_health_check(
    ...
    # Check floorplan service connectivity
    try:
